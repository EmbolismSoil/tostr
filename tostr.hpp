...
private:\
	template<class U>\
	static  uint8_t __has(typename U::_member *) {return  uint8_t();}\
\
	template<class U>\
	static  uint16_t __has(...) {return  uint16_t();}\
\
public:\
...
private:
	...
	template<class U>
	static uint8_t __has(__Helper<U, &U::to_string> *) {return uint8_t();}
...
private:
	...
	template<class U>
	static uint8_t __has(__Helper<U, &U::toString> *){return uint8_t();}
